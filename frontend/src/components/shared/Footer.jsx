...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-700 py-8 bg-black">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">Event<span className='text-[#F83002]'>Portal</span></h2>
            <p className="text-sm text-gray-400">© 2024 Rangasthalam. All rights reserved.</p>
          </div>
